  ...
  <div class="page">
    ...
    <header class="section page-header">
      ...
      <main>
             ...
             <div id="carouselExampleFade" class="carousel slide carousel-fade" data-ride="carousel" >
              <div class="carousel-inner">
                <div class="carousel-item active">
                  <img class=" img-fluid d-block w-100" src="images/румяна.png" alt="First slide">
                </div>
                <div class="carousel-item">
                  <img class=" img-fluid d-block w-100" src="images/румяна2.png" alt="Second slide">
                </div>
            </div>
        ...
        $mysqli->query($query);
        $query = "SELECT * FROM product WHERE id_product = 8 ;";
        ...
        while($row = $results ->fetch_assoc()){
          echo '
            ...
            <div class="col-4-lg">
              ...
              <br>
                    <hr>
        <h4>Румяна компактні пудрові з пензликом 01</h4>
        <hr><br>
        
        <h5>Пудрові румяна - твій ідеальний засіб для миттєвого перетворення.
        <br>Чи дозволять можливість підкреслити виразність скул, зрадити шкірі
        <br> чарівний румянець і свіжий вигляд. Насичений відтінок додасть румянцю.
        <br> В комплекті зручна кисть для нанесення.
        ...
        <br>
            ...
            <br>
            <br>      
            <br><h5><strong>Зміст:</strong></h5>Тальк, міка, магній стеарат,
            <br>диметикон, трідеціл трімелліат, капрілік, силика, нейлон-12,
            <br>ізононіл ізононат, гідрогенезірованние полісобутен, метилпарабен,
            <br>пропілпарабен, барвники Cl 77891, 15850, 45410, 77491.
        <br>
        <br>
        <br>
        <br>
