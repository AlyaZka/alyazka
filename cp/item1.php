  ...
  <div class="page">
    ...
    <header class="section page-header">
      ...
      <div class="flex-container">
             ...
             <div id="carouselExampleFade" class="carousel slide carousel-fade" data-ride="carousel" >
              <div class="carousel-inner">
               <div class="carousel-item active">
                <img class=" img-fluid d-block w-100" src="images/шампуньараматизированый.png" alt="First slide">
              </div>
            </div>
          </div>
        </div>
        ...
        $mysqli->query($query);
        $query = "SELECT * FROM product WHERE id_product = 1 ;";
        ...
        while($row = $results ->fetch_assoc()){
          echo '
            ...
            <div class="col-4-lg">
              ...
              <br>
                    <hr>
        <h4>Шампунь парфюмований</h4>
        <hr>
        <h5>Парфумований шампунь відновлює виснажені пасма за допомогою входять до складу
        <br>масел ши і безсмертника.
        <br>Пружні, гладкі, немов шовкова матерія, і такі ж блискучі, ваше волосся викликають замилування! 
        <br>

            <br><h5><strong>Обсяг:</strong></h5>600 мл
