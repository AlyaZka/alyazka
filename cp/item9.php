  ...
  <div class="page">
    ...
    <header class="section page-header">
          ...
          <div class="rd-navbar-main-outer">
            <div class="rd-navbar-main">
              ...
              <div class="rd-navbar-panel">
                ...
                <!--Navbar Brand-->
                <div class="rd-navbar-brand"><a class="brand" href="catalog.php"><img src="images/Vivi.jpg" alt=""
              ...
              <div class="rd-navbar-main-element">
                <div class="rd-navbar-nav-wrap">
                  ...
                  <ul class="rd-navbar-nav">
                    <li class="rd-nav-item"><a class="rd-nav-link" href="log.php">Вийти</a>
                    </li>
                    <li class="rd-nav-item active"><a class="rd-nav-link" href="catalog.php">Каталог</a>
                    </li>
      ...
      <main>
             ...
             <div id="carouselExampleFade" class="carousel slide carousel-fade" data-ride="carousel" >
              <div class="carousel-inner">
                <div class="carousel-item active">
                  <img class=" img-fluid d-block w-100" src="images/эсенция.png" alt="First slide">
                </div>
                <div class="carousel-item">
                  <img class=" img-fluid d-block w-100" src="images/эсенция2.png" alt="Second slide">
                </div>
            </div>
        ...
        $mysqli->query($query);
        $query = "SELECT * FROM product WHERE id_product = 9 ;";
        $results = $mysqli ->query($query);
        while($row = $results ->fetch_assoc()){
          echo '

            <div class="col-4-lg">
              <aside class="aside aside-2 text-left">
              <br>
                    <hr>
        <h4>Есенція для особи з екстрактом равлика і женьшеня </h4>
        <hr>
        <br>
        <h5>Есенція з комплексом равлики і женьшеню м яко звільняє шкіру від ороговілих частинок,
        <br> покращує обмін речовин в клітинах шкіри, сприяє збільшенню частки молодих клітин
        <br> в епідермісі, покращуючи стан шкіри, її колір і рельєф.
        
        <br>

            <br><h5><strong>Обсяг:</strong></h5>30 мл

            <br>
            <br>      
            <br><h5><strong>Зміст:</strong></h5> Aqua, Laureth Sulfate, хлорид натрію,
            <br>Cocamidopropyl Betaine, Cocamide DEA,
            <br> Glycol Distearate, Cocamide MEA, Parfum,
            <br> Rosa Canina Fruit Extract, Meethylchloroisothiazolinone,
            <br> Methylisothiazolinone, Benyl Alcohol, Citric acid, CI 17200.<br>
        <br>
        <br>

        <h3 class="font-weight-bold red-text">
            <strong>  '.$row["product_price"].' грн.</strong>
                </h3>
        <br>

        <button class="btn btn-info btn-outline-dark my-4 btn-block" type="submit" onclick="addToCart('.$row["id_product"].')">Додати до корзини</button>
