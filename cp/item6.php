    ...
    <div id="carouselExampleFade" class="carousel slide carousel-fade" data-ride="carousel" >
            <div class="carousel-inner">
              <div class="carousel-item active">
                  <img class=" img-fluid d-block w-100" src="images/пудра.png" alt="First slide">
                </div>
                <div class="carousel-item">
                  <img class=" img-fluid d-block w-100" src="images/пудра2.png" alt="Second slide">
                </div>
            </div>
        ...
        $mysqli->query($query);
        $query = "SELECT * FROM product WHERE id_product = 6 ;";
        ...
        while($row = $results ->fetch_assoc()){
          echo '
            ...
            <div class="col-4-lg">
              ...
              <br>
                    <hr>
        <h4>Пудра компактна, ефект шовку тон 01</h4>
        <hr><br>
        <h5>Компактна пудра з шовковистою текстурою. Дозволить вирівняти тон особи, надати свіжість і сяйво.
        <br>Ідеальний засіб для фіксації макіяжу. Натуральний відтінок виглядає максимально природно.
