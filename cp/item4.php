    ...
    <div id="carouselExampleFade" class="carousel slide carousel-fade" data-ride="carousel" >
            <div class="carousel-inner">
              <div class="carousel-item active">
                  <img class=" img-fluid d-block w-100" src="images/наборпамад.png" alt="First slide">
                </div>
                <div class="carousel-item">
                  <img class=" img-fluid d-block w-100" src="images/наборпамад2.png" alt="Second slide">
                </div>
            </div>
        ...
        $mysqli->query($query);
        $query = "SELECT * FROM product WHERE id_product = 4 ;";
        ...
        <hr>
        <br>
        <h5>Вибух кольору і сяючий мус для твого чудового образу!
        <br>Двоколірна глянсова помада дозволить з легкістю створити
        <br>ефект омбре і надати візуальний обсяг губок. 
        <br>Напівпрозорий мандариновий відтінок і квіткові бризки ідеально 
        <br>підходять для легкого денного макіяжу.
         
        <br>

            <br><h5><strong>Зміст: 3 памади різного кольору</strong></h5>
