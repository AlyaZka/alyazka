  ...
  <div class="page">
    ...
    <header class="section page-header">
      ...
      <div class="flex-container">
             ...
             <div id="carouselExampleFade" class="carousel slide carousel-fade" data-ride="carousel" >
              <div class="carousel-inner">
               <div class="carousel-item active">
                <img class=" img-fluid d-block w-100" src="images/лосьондлялица.png" alt="First slide">
              </div>
            </div>
          </div>
        </div>
        ...
        $mysqli->query($query);
        $query = "SELECT * FROM product WHERE id_product = 3 ;";
        ...
        while($row = $results ->fetch_assoc()){
          echo '
            ...
            <div class="col-4-lg">
              ...
              <br>
                    <hr>
        <h4>Лосьон для обличчя</h4>
        <hr>
        <br>
        <h5>Лосьйон - свого роду ексфоліант.
        <br> Він очищає обличчя і готує шкіру до подальших косметичних процедур.
        <br>
        <br>
        <br>

            <br><h5><strong>Обсяг:</strong></h5>300 мл
            <br>
            <br>
            <br>      
            <br>
            <br><h5><strong>Зміст:</strong></h5> Вода, пропилен гліколь, гліцерин,
            <br>ціклопентазілоксан, ціклогексасілоксан, екстракт гамамелісу,
            <br>амоніум акрілолойдіметілтаурат / кополімер, феноксіетанол, карбомер,
            <br> bis-peg / ppg 20/5 диметикон, капрілік / каприк тригліцерид,
            <br> триетаноламін, метилпарабен, метілсотіазолінон, ароматизатор,
            <br> дісодіум ЕДТА, содиум гіалуронат, ніацинамід.
        <br>
        <br>
