    ...
    <div id="carouselExampleFade" class="carousel slide carousel-fade" data-ride="carousel" >
            <div class="carousel-inner">
              <div class="carousel-item active">
                  <img class=" img-fluid d-block w-100" src="images/шапочка.png" alt="First slide">
                </div>
                <div class="carousel-item">
                  <img class=" img-fluid d-block w-100" src="images/шапочка2.png" alt="Second slide">
                </div>
            </div>
        ...
        $mysqli->query($query);
        $query = "SELECT * FROM product WHERE id_product = 7 ;";
        ...
        while($row = $results ->fetch_assoc()){
          echo '
            ...
            <div class="col-4-lg">
              ...
              <br>
                    <hr>
        <h4>Шапочка-рушник</h4>
        <hr><br>
        <h5>Приголомшливо милий і функціональний набір для ванної.<br>

        <br>Шапочка після душа - це саме те, що потрібно! При цьому дуже зручна у використанні
