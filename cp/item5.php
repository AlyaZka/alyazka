    ...
    <div id="carouselExampleFade" class="carousel slide carousel-fade" data-ride="carousel" >
            <div class="carousel-inner">
              <div class="carousel-item active">
                  <img class=" img-fluid d-block w-100" src="images/патчи.png" alt="First slide">
                </div>
                <div class="carousel-item">
                  <img class=" img-fluid d-block w-100" src="images/патчи2.png" alt="Second slide">
                </div>
            </div>
        ...
        $mysqli->query($query);
        $query = "SELECT * FROM product WHERE id_product = 5 ;";
        ...
        while($row = $results ->fetch_assoc()){
          echo '
            ...
            <div class="col-4-lg">
              ...
              <br>
                    <hr>
        <h4>Гідрогелеві патчі для очей</h4>
        <hr><br>
        <h5>Для екстреного догляду за чутливою і тонкою шкірою під очима
        <br> підійде набір омолоджуючих гідрогелевих патчів.
        <br>
        <br> 
        <br>
           ...
                
            <br>
            <br>Призначення: ліфтинг, від темних кіл, зволоження
            <br>Час застосування: універсальний
            <br>Пол: для жінок
            <br>Класифікація: мідл маркет<br>
            <br>
            <br> 
        <br>
        <br>
